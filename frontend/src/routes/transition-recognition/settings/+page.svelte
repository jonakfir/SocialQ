...
<style>
  ...
  th, td { padding: 12px 14px; text-align: center; border-bottom: 1px solid rgba(0,0,0,0.13); color: inherit; }
  ...
  :global(html.dark) .btn:hover { background: #4f46e5; color: #fff; border-color: #4f46e5; }
