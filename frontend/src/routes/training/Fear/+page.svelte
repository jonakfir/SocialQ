<script lang="ts">
  ...
  const QUOTE_ATTR = '— Franklin D. Roosevelt';
  ...
  const tips: Array<{
    ...
    { key: 'brows', title: 'Brows', text: 'Fear eyebrows appear raised and straightened, similar to surprise.', x: '95%', y: '32%', label: 'Brows' },
    { key: 'eyes',  title: 'Eyes',  text: 'Eyes open and tense during fear, exposing the ‘whites’ of your eyes.',   x: '95%', y: '39%', label: 'Eyes'  },
    { key: 'mouth', title: 'Mouth', text: 'Mouth opens and lips are pulled back.',     x: '95%', y: '62%', label: 'Mouth' }
  ];
